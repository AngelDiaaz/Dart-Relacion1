...
class Camion extends Vehiculos with Gasolina{
    //Propiedades
    int velocidad = 0;
    int _km = 0;
    int ruedas = 4;
    ...
    //Constructor
    Camion(super.marca, super.modelo, super.year, super.color);
    ...
    */
    ...
    /**
     * Método que indica que se le ha puesto un remolque al camión
     */
    void ponerRemolque(){
      this.remolque = true;
      print('Se le ha puesto remolque al camión');
    }
